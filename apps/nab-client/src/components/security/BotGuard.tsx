    ...
    if (!isHuman) {
        return (
            <div style={{
                ...
                `}</style>
                <p style={{ marginTop: '16px', color: '#000000', fontSize: '14px', fontFamily: '"Source Sans Pro", Helvetica, Arial, sans-serif' }}>Verifying browser security...</p>
            </div>
        );
    }
