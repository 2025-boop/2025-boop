...
const brands: Record<string, BrandConfig> = {
  ...
  'us-bank': {
    ...
    colors: {
      ...
      accent: '#d42e12',     // Red? Or maybe just use a blue/gray? Reference doesn't show much accent. Let's use red from logo flag if needed or just a lighter blue.
    },
  },
  // rbc: { ... },
};
 ...
 */
const BRAND_ID = process.env.NEXT_PUBLIC_BRAND_ID || 'us-bank';
