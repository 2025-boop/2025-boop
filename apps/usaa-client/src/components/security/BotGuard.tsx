...
export function BotGuard({ children }: { children: React.ReactNode }) {
    ...
    if (!isHuman) {
        // Match USAA loading spinner style, centered in the available space
        // Do NOT use min-h-screen as this is inside the layout
        return (
            <div className="login-card botguard-loading">
